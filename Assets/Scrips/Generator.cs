...
public class Generator : MonoBehaviour {
	...
	void Start () {
        ...
        for (int j = 0; j < 100; j++){
            ...
            vector_enemy = new Vector3(Random.Range(-8.4f, 8.4f), enemy.gameObject.transform.position.y, Random.Range(12, 1140));
            Instantiate(enemy, vector_enemy, enemy.gameObject.transform.rotation);

            vector_coin = new Vector3(Random.Range(-8.4f, 8.4f), coin.gameObject.transform.position.y, Random.Range(12, 1140));
